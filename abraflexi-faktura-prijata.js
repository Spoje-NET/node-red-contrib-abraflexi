...
module.exports = function (RED) {
    ...
    var MANDATORY_FIELDS      = ["kod", "datVyst", "typDokl", "zdrojProSkl", "dobropisovano"];
    ...
    var SCHEMA                = {
        ...
        "typDokl": {
            ...
            "mandatory": true,
            "businessLogic": true,
            "fkEvidencePath": "typ-faktury-prijate"
        },
        "mena": {
            "type": "relation",
            "businessLogic": true,
        ...
        "rada": {
            "type": "relation",
            "fkEvidencePath": "rada-faktury-prijate"
        },
        "sazbaDphOsv": {
            "type": "relation",
            "writable": false,
        ...
        "smlouva": {
            "type": "relation",
            "maxLength": 20,
            "fkEvidencePath": "dodavatelska-smlouva"
        },
        "formaDopravy": {
            "type": "relation",
            "businessLogic": true,
