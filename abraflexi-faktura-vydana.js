...
module.exports = function (RED) {
    ...
    var MANDATORY_FIELDS      = ["kod", "varSym", "datVyst", "metodaZaokrDoklK", "vytvaretKorPol", "typDokl", "zaokrouhlitPoOdpoctu", "zdrojProSkl", "dobropisovano"];
    ...
    var BUSINESS_LOGIC_FIELDS = ["id", "lastUpdate", "kod", "zamekK", "cisDosle", "varSym", "cisObj", "datVyst", "duzpPuv", "duzpUcto", "datSplat", "datSazbyDph", "sumOsv", "sumZklSniz", "sumZklSniz2", "sumZklZakl", "sumDphSniz", "sumDphSniz2", "sumDphZakl", "sumCelkSniz", "sumCelkSniz2", "sumCelkZakl", "sumCelkem", "sumOsvMen", "sumZklSnizMen", "sumZklSniz2Men", "sumZklZaklMen", "sumDphZaklMen", "sumDphSnizMen", "sumDphSniz2Men", "sumCelkSnizMen", "sumCelkSniz2Men", "sumCelkZaklMen", "sumCelkemMen", "slevaDokl", "kurz", "kurzMnozstvi", "dic", "postovniShodna", "bezPolozek", "ucetni", "szbDphSniz", "szbDphSniz2", "szbDphZakl", "uzpTuzemsko", "datUcto", "storno", "zaokrJakSumK", "zaokrNaSumK", "zaokrJakDphK", "zaokrNaDphK", "metodaZaokrDoklK", "vytvaretKorPol", "typDokl", "mena", "firma", "stat", "faStat", "mistUrc", "banSpojDod", "bankovniUcet", "typUcOp", "primUcet", "protiUcet", "dphZaklUcet", "dphSnizUcet", "dphSniz2Ucet", "statDph", "clenDph", "stredisko", "cinnost", "zakazka", "kontaktOsoba", "sazbaDphOsv", "sazbaDphSniz", "sazbaDphSniz2", "sazbaDphZakl", "formaDopravy", "ekokomK", "clenKonVykDph", "formaUhradyCis", "stavUhrK", "stavOdpocetK", "zaokrouhlitPoOdpoctu", "osobUpravaDph"];
    var SCHEMA                = {
        "id": {
            "type": "integer",
            "writable": false,
        ...
        "rada": {
            "type": "relation",
            "fkEvidencePath": "rada-faktury-vydane"
        },
        "sazbaDphOsv": {
            "type": "relation",
            "writable": false,
